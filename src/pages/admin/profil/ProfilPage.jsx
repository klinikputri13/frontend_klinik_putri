    ...
    <section className="capitalize">
      ...
      <form method="post" onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-3" encType="multipart/form-data">
        <div className="content-center space-y-5 justify-items-center">
          <img src={auth.user.fotoUrl ? auth.user.fotoUrl : "https://media.istockphoto.com/id/1147544807/vector/thumbnail-image-vector-graphic.jpg?s=612x612&w=0&k=20&c=rnCKVbdxqkjlcs3xH87-9gocETqpspHFXu5dIGB4wuM="} alt={auth.user.name} className="object-cover object-center rounded-full w-[186px] bg-white" />
