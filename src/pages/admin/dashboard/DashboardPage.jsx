      ...
      <section className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {spesialisasiTakeAllQueries.data?.map((spesialisasi) => (
          <article key={spesialisasi.id} className="p-6 bg-white rounded-lg shadow-md">
            ...
            <img src={spesialisasi.fotoUrl ?? "https://media.istockphoto.com/id/1147544807/vector/thumbnail-image-vector-graphic.jpg?s=612x612&w=0&k=20&c=rnCKVbdxqkjlcs3xH87-9gocETqpspHFXu5dIGB4wuM="}
